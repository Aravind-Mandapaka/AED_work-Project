...
public class OrderRequestForHospital extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Vaccine", "Quantity", "Sender", "Receiver", "Commitee comment", "Director comment", "CDC Comment", "Status"
            }
        ));
        jScrollPane1.setViewportView(workRequestJTable);

        add(jScrollPane1);
        jScrollPane1.setBounds(10, 160, 980, 130);
        ...
        requestVaccineBtn.setBounds(590, 330, 230, 30);
